...
| 11 | adjudication_engine | exclusions.claim_level | PASS | Diagnosis/treatment ('Chronic Joint Pain ; Panchakarma Therapy') matches no policy exclusion. |
| 12 | adjudication_engine | waiting_period.initial | PASS | Initial 30-day waiting period complete (joined 2024-04-01). |
...
| 11 | adjudication_engine | exclusions.claim_level | FAIL | 'Morbid Obesity — BMI 37 ; Bariatric Consultation and Customised Diet Plan' matches policy exclusion 'Bariatric surgery' (matched on: bariatric). This condition is not covered under the policy at any time. |
| 12 | adjudication_engine | waiting_period.initial | PASS | Initial 30-day waiting period complete (joined 2024-04-01). |
